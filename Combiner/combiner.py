...
# Specify the path to the input file and output details
input_folder = 'gen_files'  # Directory where the input CSV file is located
input_csv = os.path.join(input_folder, 'contacts.csv')  # Full path to the input CSV file
